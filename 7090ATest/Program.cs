// Copyright (c) 2026 Tony Goodhew. All rights reserved.
        ...
        private static void ExecutePlottingSequence()
        {
            ...
            AnsiConsole.Progress()
                ...
                .Start(ctx => 
                {
                    ...
                    gpibSession.FormattedIO.WriteLine("PA1032,850;SP4;");
                    ...
                    gpibSession.FormattedIO.WriteLine($"PA4830,750;LBX Axis{EndOfTextChar}");
                    task.Increment(ProgressPenRepeatability);
